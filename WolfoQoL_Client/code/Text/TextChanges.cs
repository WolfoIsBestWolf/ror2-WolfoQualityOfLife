...
namespace WolfoQoL_Client.Text
{
    ...
    public class TextChanges
    {
        ...
        private static void PurchaseInteraction_GetContextString(ILContext il)
        {
            ...
            {
                WolfoMain.log.LogWarning("IL Failed: PurchaseInteraction_GetContextString");
            }
        }
        ...
        private static void IL_PICKUP(MonoMod.Cil.ILContext il)
        {
            ...
            {
                WolfoMain.log.LogWarning("IL Failed: SIL_PICKUP");
            }
        }
        ...
        private static void AddVoidQuantity(On.RoR2.GenericPickupController.orig_HandlePickupMessage orig, UnityEngine.Networking.NetworkMessage netMsg)
        {
            ...
            if (WConfig.cfgMessagesVoidQuantity.Value)
            {
                ...
                WolfoMain.log.LogMessage(Chat.log[Chat.log.Count - 1]);
            }
        }
