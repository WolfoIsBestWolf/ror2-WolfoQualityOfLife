...
namespace WolfoQoL_Client
{
    ...
    public class v
    {
        ...
        public static Texture2D dummytex192 = new Texture2D(192, 192, TextureFormat.DXT5, false);
        public static Texture2D dummytex256 = new Texture2D(256, 256, TextureFormat.DXT5, false);
        public static Texture2D dummytexwide = new Texture2D(384, 256, TextureFormat.DXT5, false);
