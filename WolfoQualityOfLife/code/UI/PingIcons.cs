...
namespace WolfoQualityOfLife
{
    public class PingIcons
    {
        ...
        public static void Start()
        {
            ...
            //Why there be 2 of them
            PingIcons.TeleporterChargedIcon = LegacyResourcesAPI.Load<GameObject>("Prefabs/PositionIndicators/TeleporterChargingPositionIndicator").GetComponent<RoR2.UI.ChargeIndicatorController>().iconSprites[0].sprite;
            On.RoR2.TeleporterInteraction.Awake += (orig, self) =>
            {
                RoR2.UI.ChargeIndicatorController original = LegacyResourcesAPI.Load<GameObject>("Prefabs/PositionIndicators/TeleporterChargingPositionIndicator").GetComponent<RoR2.UI.ChargeIndicatorController>();
        ...
        public static void Pings_Other()
        {
            ...
            LegacyResourcesAPI.Load<GameObject>("Prefabs/networkedobjects/teleporters/LunarTeleporterProngs").AddComponent<PingInfoProvider>().pingIconOverride = PrimordialTeleporterIcon;
            ...
            Addressables.LoadAssetAsync<GameObject>(key: "RoR2/DLC2/ShrineHalcyonite.prefab").WaitForCompletion().AddComponent<PingInfoProvider>().pingIconOverride = CubeIcon;
