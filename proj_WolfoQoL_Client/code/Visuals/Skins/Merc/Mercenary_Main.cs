...
namespace WolfoQoL_Client.Skins
{
    public static class Mercenary_Main
    {
        ...
        public static void EffectReplacements()
        {
            ...
            EffectReplacer.SetupComponent(effect, Merc_Red.MercSwordSlashWhirlwind_Red, Merc_Green.MercSwordSlashWhirlwind_Green, Merc_Pink.MercSwordSlashWhirlwind_Pink, false);
            //M2 Alt
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/MercSwordUppercutSlash.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.MercSwordUppercutSlash_Red, Merc_Green.MercSwordUppercutSlash_Green, Merc_Pink.MercSwordUppercutSlash_Pink, false);
            //M3
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/ImpactMercAssaulter.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.ImpactMercAssaulter_Red, Merc_Green.ImpactMercAssaulter_Green, Merc_Pink.ImpactMercAssaulter_Pink, false);
            //M3 Alt
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/ImpactMercFocusedAssault.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.ImpactMercFocusedAssault_Red, Merc_Green.ImpactMercFocusedAssault_Green, Merc_Pink.ImpactMercFocusedAssault_Pink, false);

            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/MercFocusedAssaultOrbEffect.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.MercFocusedAssaultOrbEffect_Red, Merc_Green.MercFocusedAssaultOrbEffect_Green, Merc_Pink.MercFocusedAssaultOrbEffect_Pink, false);


            //M4 ?
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/ImpactMercEvis.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.ImpactMercEvis_Red, Merc_Green.ImpactMercEvis_Green, Merc_Pink.ImpactMercEvis_Pink, false);

            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/OmniImpactVFXSlashMercEvis.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.OmniImpactVFXSlashMercEvis_Red, Merc_Green.OmniImpactVFXSlashMercEvis_Green, Merc_Pink.OmniImpactVFXSlashMercEvis_Pink, false);

            //General
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/OmniImpactVFXSlashMerc.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.OmniImpactVFXSlashMerc_Red, Merc_Green.OmniImpactVFXSlashMerc_Green, Merc_Pink.OmniImpactVFXSlashMerc_Pink, false);

            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Merc/MercExposeConsumeEffect.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.MercExposeConsumeEffect_Red, Merc_Green.MercExposeConsumeEffect_Green, Merc_Pink.MercExposeConsumeEffect_Pink, false);


            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Huntress/HuntressBlinkEffect.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.HuntressBlinkEffect_Red, Merc_Green.HuntressBlinkEffect_Green, Merc_Pink.HuntressBlinkEffect_Pink, true);
            effect = Addressables.LoadAssetAsync<GameObject>(key: "RoR2/Base/Huntress/HuntressFireArrowRain.prefab").WaitForCompletion();
            EffectReplacer.SetupComponent(effect, Merc_Red.HuntressFireArrowRain_Red, Merc_Green.HuntressFireArrowRain_Green, Merc_Pink.HuntressFireArrowRain_Pink, true);
        ...
        public static void GhostReplacements()
        {
            ...
            replacer1.ghostPrefab_3 = Merc_Pink.EvisProjectileGhost_Pink;
            replacer1.impactPrefab_3 = Merc_Pink.MercSwordFinisherSlash_Pink;
            ...
            replacer2.ghostPrefab_3 = Merc_Pink.EvisOverlapProjectileGhost_Pink;
