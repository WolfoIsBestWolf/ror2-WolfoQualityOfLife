...
namespace WolfoQoL_Client.Skins
{
    public static class Skins_REX
    {
        ...
        public static void Start()
        {
            ...
            Material matTreebotAltSolus_Flower = Addressables.LoadAssetAsync<Material>(key: "63e4556772c5f2d42a728d700b486682").WaitForCompletion();
            Material MatTreebot_VineSots = GameObject.Instantiate(matTreebotTreeFlower);
            Material MatTreebot_VineAC = GameObject.Instantiate(matTreebotAltSolus_Flower);
            ...
            /*
                - _GradientCenter: 1.42
                - _GradientSmoothness: 1.11
                - _GradientWidth: 1.27
            */

            //MatTreebot_VineAC.SetFloat("_DstBlend", 4f);
            MatTreebot_VineAC.SetColor("_TintColor", new Color(0.1804f, 0.1804f, 0.1804f, 1f));
            MatTreebot_VineAC.SetColor("_VertColor", new Color(0.8784f, 0.3176f, 0.4084f, 1f));
            MatTreebot_VineAC.SetFloat("_GradientWidth", 144f);
            //MatTreebot_VineAC.SetFloat("_WireframeThickness", 0.1f);
            MatTreebot_VineAC.SetFloat("_EmBoost", 0.1f);
            MatTreebot_VineAC.SetTexture("_RemapTex", null);
            MatTreebot_VineAC.SetTexture("_EmTex", null);
            MatTreebot_VineAC.SetTexture("_ScrollTex", null);
            ...
            SkinDefParams skinTreebotAltSolus = Addressables.LoadAssetAsync<SkinDefParams>(key: "d5b044f71d9036441bd5d27e5aa8b9c7").WaitForCompletion();
            HG.ArrayUtils.ArrayAppend(ref skinTreebotAltSolus.rendererInfos, new CharacterModel.RendererInfo
            {
                defaultMaterial = MatTreebot_VineAC,
                defaultShadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off,
                renderer = vine
            });
        }
